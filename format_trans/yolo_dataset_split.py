...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-dir', type=str,default='images_20230623', help='image path dir')
    parser.add_argument('--txt-dir', type=str,default='./20230624_txt' , help='txt path dir')
    parser.add_argument('--save-dir', default='./20230624_split',type=str, help='save dir')
